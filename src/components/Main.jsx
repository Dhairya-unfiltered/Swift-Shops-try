...
const Main = () => {
  ...
  <div className='content'>
    ...
    <a href="https://tally.so/r/n0Zzp6"><button type="button" class="text-white bg-pink-500 font-semibold rounded-full text-lg md:text-2xl px-5  text-center mt-5"><img src={sparkle} className='sparkleimg' />Join the Waitlist</button></a>
    </div>
  </div>
